    ...
    content: [
      {
        ...
        content: ["Conducted sessions about React, Next.js, Flutter, etc."],
      },
      {
        title: "GSA InfoTeam",
        link: "https://introduce.gistory.me",
        description: "2023.03 ~ Present",
        subDescription: "Team Leader",
        content: ["Service development for GIST students"],
      },
      {
        title: "MOP",
        link: "",
        ...
        content: ["Study on the Start-up ecosystem", "Team Project"],
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        content: [
          ...
          "Developed a school management system JshsUS",
        ],
      },
    ],
  },
