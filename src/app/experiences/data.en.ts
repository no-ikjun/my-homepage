export const educations = [
  ...
  },
  {
    ...
    image:
      "https://i.namu.wiki/i/-HzxAZolSdwprRfrTtp0rumE3ePx8Ti8ucrnLkRcOwkFCKZjEp_wv_KmeeqD9kisGOxSGD9sS7JCAmUU12E_uA.webp",
...
export const awards = [
  ...
  },
  {
    ...
    description: "2023.07",
    subDescription: "🥈 2nd prize (Service Development Excellence Award)",
    content: [
      "Platform for participation in the politics of the common people - Mefeto",
    ],
  },
  {
    title: "2024 KPMG Ideathon@Samjong KPMG",
  ...
  },
  {
    ...
    description: "2025.05",
    subDescription: "🥈 2nd prize (GIST AI Research Institute Director's Award)",
    content: [
      "AI-based news article platform to solve echo chamber phenomenon - Agora",
    ],
  },
];
